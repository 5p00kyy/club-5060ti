...
| 2x RTX 5060 Ti | [Qwen3.8 27B Q6_K](examples/llamacpp-qwen38-27b-dual-5060ti.ini) | 131K single-slot tier, two uncached ~115.4K-token retrieval checks, and two ~91.8K-token sustained runs that generated 3,072 tokens and reached visible answers with built-in MTP. | [Evidence bundle](data/evidence/qwen38-27b-q6-2x5060ti-131k.json) |
...
| upstream llama.cpp | Qwen3.8 27B GGUF | Published evidence | Newest measured family. Single-card IQ3_XXS 64K q8 KV is the recommended one-card route. Dual-card Q6_K 131K f16 KV is a validated higher-quality alternative, sustaining ~38.6 tok/s median decode at ~91.8K prompt tokens. See docs/llamacpp-qwen38.md. |
